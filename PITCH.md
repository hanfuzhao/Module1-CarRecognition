...
Speaker notes for a 5-minute, hard-stop pitch. Four beats: Problem → Approach →
Live Demo → Results/Insights. All numbers are real (`data/outputs/metrics.json`).
...
- **The model learned real structure:** its top confusions are
  *Chevrolet Express ↔ GMC Savana* and *Dodge ↔ Mercedes Sprinter* — literally
