...
**Quick links:** [Live demo](https://HanfuZhao781-car-recognition.hf.space), [Report](TECHNICAL_REPORT.md), [Pitch](PITCH.md), [Models](models/), [Pull Requests](https://github.com/hanfuzhao/Module1-CarRecognition/pulls)
...
| Docs on where each model lives | [README results table](README.md) (model class + weight file for each) |
